...
stripe.api_key = os.getenv("stripe.api_key2")
...
collections = {
    'customers': 'stripe2_customers',
    'invoices': 'stripe2_invoices',
    'balance_transactions': 'stripe2_balance_transactions',
    'charges': 'stripe2_charges'
}
